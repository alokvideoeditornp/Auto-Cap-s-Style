...
const AnimatedItem: React.FC<{
  ...
  if (isHighlighted && styleConfig.highlightStyle === 'highlight') {
    extraStyles.backgroundColor = styleConfig.accentColor;
    extraStyles.padding = styleConfig.displayMode === 'letter' ? '0px 2px' : '0px 16px';
    extraStyles.borderRadius = '16px';
    finalColor = styleConfig.backgroundColor || '#000000';
  ...
  return (
    <span
      style={{
        ...
        color: finalColor,
        fontSize,
        transition: 'color 0.1s ease', // fontSize transition removed because it glitches Remotion rendering
        ...extraStyles,
      }}
    >
      {char}
